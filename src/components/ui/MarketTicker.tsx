...
const MarketTicker = () => {
  ...
  return (
    <div className="w-screen bg-black/85 px-16 py-3 fixed top-0 left-0 z-50 text-green-400 font-mono text-[15px] border-b border-white/10 shadow-md backdrop-blur-lg flex items-center justify-center gap-10">
