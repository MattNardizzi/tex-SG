...
export default function ReflexCortexPanel() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full h-full px-8 py-10 rounded-panel bg-black text-white font-mono text-[1.8rem] border-2 border-pink-400 shadow-[0_0_90px_rgba(255,0,150,0.45)] flex flex-col items-center justify-center overflow-hidden"
    >
      ...
      >
        ...
        <div className="flex items-center justify-center h-full">
          <span className="text-pink-300 tracking-widest text-[1.2rem] font-bold">REFLEX CORTEX</span>
        </div>
      </motion.div>
