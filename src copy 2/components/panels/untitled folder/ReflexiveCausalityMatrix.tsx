...
const generateCausalInsight = () => {
  ...
  return {
    ...
    effect: outcomes[Math.floor(Math.random() * outcomes.length)],
    path,
...
export default function ReflexiveCausalityMatrix() {
  ...
  useEffect(() => {
    const interval = setInterval(() => setInsight(generateCausalInsight()), 11000);
            ...
            {slide === 2 && (
              <>
                ...
                <div className="font-mono text-[10px]">
                  Displacement Score: <span className="text-yellow-300">{insight.path.displacement}</span>
                </div>
                <div className="font-mono text-[9.5px] text-white/60">
