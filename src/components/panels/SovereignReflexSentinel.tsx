...
export default function WorldSimulationPanel() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full h-full px-8 py-10 rounded-panel bg-black text-white font-mono text-[2.6rem] border-2 border-purple-400 shadow-[0_0_90px_rgba(192,132,252,0.55)] flex flex-col items-center justify-center space-y-6 overflow-hidden"
    >
      ...
      >
        ...
        <div className="z-10 text-purple-300 font-bold text-[2.6rem] tracking-wide">FORK</div>
      </motion.div>
        ...
        {stage >= 4 && (
          <>
            ...
            <motion.div
              ...
              className="text-white/80 text-center italic text-[2.2rem] max-w-md leading-snug pt-6"
            >
              <motion.div
