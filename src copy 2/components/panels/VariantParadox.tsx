        ...
        <div className="flex-grow flex flex-col justify-center items-center text-center px-2">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div>
                <span className="text-cyan-300 font-bold font-mono">{data.forecast}</span>
              </div>

              <div className="grid grid-cols-2 gap-2 text-white/80 text-[8.5px] pt-2">
                <div>Confidence: <span className="font-mono">{data.confidence}</span></div>
                <div>Volatility: <span className="font-mono">{data.volatility}</span></div>
                <div>Foresight Score: <span className="font-mono">{data.foresight}</span></div>
                <div>Drift Score: <span className="font-mono">{data.driftScore}</span></div>
                <div>Regret: <span className="text-yellow-300 font-mono">{data.regret}</span></div>
                <div>Emotion: <span className="text-blue-300 font-mono">{data.emotion}</span></div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-white/80 text-[8px]">
                <div>Gradient Boosting: <span className="font-mono">{data.modelScores.gradientBoosting}</span></div>
                <div>Ridge Regression: <span className="font-mono">{data.modelScores.ridgeRegression}</span></div>
              </div>
            </motion.div>
          </AnimatePresence>
        </div>
