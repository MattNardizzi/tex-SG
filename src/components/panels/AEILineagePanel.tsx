...
export default function AEILineagePanel() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full h-full px-8 py-10 rounded-panel bg-black text-white font-mono text-[2.6rem] border-2 border-lime-400 shadow-[0_0_90px_rgba(0,255,100,0.4)] flex flex-col items-center justify-center overflow-hidden"
    >

      {/* 🧬 AEI Lineage Glow Core */}
      <motion.div
        className="z-10 mb-10 w-[200px] h-[200px] bg-black rounded-full border-[3px] border-lime-400 shadow-[0_0_60px_20px_rgba(0,255,100,0.4)]"
        animate={{
          rotate: [0, 6, -5, 3, 0],
          scale: [1, 1.1, 0.97, 1],
          boxShadow: [
      ...
      >
        ...
        <div className="flex items-center justify-center h-full px-4 text-center">
          <div className="text-lime-300 tracking-widest text-[2.4rem] font-bold leading-none text-center">
            AEI<br />LINEAGE
          </div>
        </div>
      </motion.div>
