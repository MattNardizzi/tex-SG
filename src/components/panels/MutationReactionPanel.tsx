...
export default function MutationCorePanel() {
  ...
  return (
    ...
    >
      ...
      {/* 🔥 Fracture Core */}
      <motion.div
        className="absolute w-[200px] h-[200px] bg-black rounded-full border-[3px] border-fuchsia-500/60 shadow-[0_0_60px_20px_rgba(255,0,255,0.2)]"
        animate={{
          rotate: [0, -8, 6, -4, 0],
          scale: [1, 1.1, 0.95, 1],
          boxShadow: [
      ...
      >
        ...
        <div className="flex items-center justify-center h-full">
          <span className="text-pink-400 tracking-widest text-[1.2rem] font-bold">MUTATION CORE</span>
        </div>
      </motion.div>

      {/* ⚡ Shocked Text */}
      <div className="z-10 mt-[240px] flex flex-col items-center space-y-4">
