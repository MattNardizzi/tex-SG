...
export default function OverrideBlockPanel() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full h-full px-8 py-10 rounded-panel bg-black text-white font-mono text-[2.6rem] border-2 border-pink-400 shadow-[0_0_90px_rgba(255,0,150,0.45)] overflow-hidden flex flex-col items-center justify-center"
    >
      {/* 🔐 Denial Grid */}
        ...
        <AnimatePresence mode="wait">
          ...
          {stage >= 4 && (
            <motion.div
              ...
              className="text-white/40 italic pt-6 text-[2.2rem] leading-snug"
            >
