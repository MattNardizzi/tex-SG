// components/panels/CodexPatchHistory.tsx
...
type CodexPatchHistoryProps = {
  patches: CodexPatch[];
};

export default function CodexPatchHistory({ patches }: CodexPatchHistoryProps) {
  return (
        ...
        {patches.map((patch, idx) => (
          ...
          >
            <div className="text-xs text-white/40 tracking-wider">
              ⏱ {patch.timestamp} • 🧠 Module: <span className="text-white/70">{patch.targetModule}</span>
            </div>
